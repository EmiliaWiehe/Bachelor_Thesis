...
# def build_vit_model(num_classes=4, pretrained=True):
#     """
...
#     model_name = "google/vit-base-patch16-224-in21k"  # Can be changed to another variant
...
#     return ViTClassifier(vit, num_classes)
